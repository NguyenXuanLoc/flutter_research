...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> initOneTrust() async {
    ...
    try {
      status =
          await OTPublishersNativeSDK.startSDK("cdn.cookielaw.org", appId, '');
                ...
                child: Container(alignment: Alignment.bottomCenter,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("sddsff", style: TextStyle(color: Colors.white)),
                    ],
                  ),
  ...
  Widget itemBottomNavigationBar() => Expanded(
          child: Column(mainAxisSize: MainAxisSize.min,
        children: [Icon(Icons.add), Text('sdlfk')],
      ));
}
